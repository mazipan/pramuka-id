  ...
  sections: [
    {
      ...
      description: 'Pembagian TKK berdasarkan bidang keahlian ditandai dengan perbedaan Warna Dasar dari TKK tersebut',
      groupType: 'object',
      groups: [
        {
          text: 'Warna Putih',
        ...
        {
          text: 'Warna Kuning',
          description: 'Warna Kuning Untuk TKK Bidang Agama, Mental, Moral, Spiritual, Pembentukan Pribadi, dan Watak',
          lists: [
            'TKK Salat',
            'TKK Khatib',
            'TKK Qori',
    ...
    {
      name: 'Pemasangan TKK',
      description: 'TKK dipasang di lengan sebelah kanan baju seragam, dengan dua pilihan pemasangan',
      groupType: 'array',
      groups: [
