export default {
  ...
  dataCara: {
    ...
    paragraph: ['Berikut ini adalah panduan menggunakan kompas agar mendapat arah yang akurat, yaitu:'],
    list: [
    ...
    list: [
      {
        ...
        desc:
          'Kompas ini adalah jenis yang paling umum digunakan karena harganya relatif murah. Kompas analog atau biasa ini berisi jarum magnet yang direndam dalam suatu cairan.',
      },
      {
        ...
        desc:
          'Tipe kompas bidik biasanya digunakan oleh TNI, Tim SAR, Navigator dan pendaki gunung. Kompas ini mempunyai garis lembut dengan poros vertikal yang berfungsi untuk membidik sasaran dan menentukan derajat posisi sasaran.',
      },
      {
        title: 'Kompas Silva',
        image:
        ...
        desc:
          'Kompas silva adalah salah satu jenis kompas yang biasa dipakai dalam bidang topografi. Kompas ini mempunyai protektor datar yang berfungsi sebagai tempat pada peta topografi. Kompas ini digunakan untuk membantu navigasi di daratan.',
      },
      {
        title: 'Kompas Thumb',
        image:
        ...
        desc:
          'Thumb Compass adalah jenis kompas yang mirip dengan kompas silva, hanya saja memiliki model yang berbeda. Kompas ini digunakan seperti cincin yang dipasang di ibu jari atau jempol.',
      },
      {
        ...
        desc:
          'Kompas digital memiliki tingkat akurasi yang baik, sebab penentuan arah telah menggunakan komputerasi dan data disajikan secara digital.',
      },
      {
        ...
        desc:
          'Kompas jenis ini terintegrasi dengan satelit. Kompas GPS dapat digunakan pada area blank spot. Teknologi dalam menentukan arah ini telah diadopsi pada sistem GPS mobil yang dapat juga menampilkan pergerakan si pengguna.',
      },
      {
        title: 'Kompas Kiblat',
        image:
        ...
        desc:
          'Jenis kompas ini dimanfaatkan untuk menentukan arah dan posisi kiblat bagi umat muslim. Biasa digunakan ketika mengawali pembangunan mushola atau masjid.',
      },
      {
        ...
        desc:
          'Kompas nahkoda merupakan kompas yang digunakan di bidang pelayaran. Kompas ini sangat presisi dan tahan terhadap goncangan ketika terkena ombak besar.',
      },
      {
        ...
        desc:
          'Teknologi ini merupakan jenis kompas yang tertanam di smartphone kita. Solid State Compass adalah perangkat keras yang juga disematkan pada beberapa benda lain, seperti jam tangan, serta gadget lain yang memiliki fitur kompas.',
      },
      {
        ...
        desc:
          'Kompas ini diandalkan bagi para pegiat di bidang astronomi atau orang-orang yang tengah menjalajahi daerah kutub. Jenis kompas ini sangat akurat dan memiliki fitur letak geografis bujur dan lintang.',
      },
      {
        title: 'Kompas Gyro',
        image:
        ...
        desc:
          'Kompas Gyro adalah sistem kompas yang mampu mempertahankan orientasi dengan prinsip ketetapan momentum sudut sehingga tahan terhadap goncangan dan sangat presisi.',
      },
    ],
  },
}
