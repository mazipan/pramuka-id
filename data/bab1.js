export default {
  num: 'BAB I',
  title: 'TRI SATYA DAN DASA DHARMA PRAMUKA',
  preface:
    'Adapun Janji (sumpah) Pramuka yaitu Tri Satya yang artinya adalah kata-kata janji atau sumpah yang diucapkan oleh seorang Pramuka golongan Penggalang, Penegak, Pandega dan anggota dewasa.',
  sections: [
    {
      id: 'tri-satya',
      title: 'Tri Satya',
    ...
    },
    {
      ...
      data: {
        ...
        meanings: {
          refer: true,
          preface:
            'Arti dari masing-masing bait Dasa Dharma tersebut di atas adalah sebagai berikut:',
          data: [
            {
              details: [
