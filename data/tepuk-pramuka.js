export default {
    ...
    meaning: 'Tepuk Pramuka Dalam materi pelajaran pramuka siaga maupun penggalang sangat bermacam macam. Tepuk pramuka juga di ajarkan di sekolah taman kanak kanak (TK)  dan Sekolah Dasar (SD) sebagai game pelajaran agar anak anak tidak jenuh saat belajar.',
    sections: [
      {
        name: 'Macam-macam Tepuk Pramuka Siaga',
        description: 'Daftar macam tepuk pramuka yang bisa dipelajari atau dijadikan sebagai bahan untuk diajarkan ke anak didik anda',
        groupType: 'object',
        groups: [
          {
          ...
          },
          {
            text: 'Tepuk Mata',
            lists: [
              'Tepuk 3 Kali - lirik kanan',
              'Tepuk 3 Kali - lirik kiri',
              'Tepuk 3 Kali - mata',
            ]
          },
          {
