export default {
  ...
  other: [
    { img: 'https://upload.wikimedia.org/wikipedia/commons/d/d5/Semaphore_Ready.svg', text: 'Siap/Istirahat' },
    { img: 'https://upload.wikimedia.org/wikipedia/commons/3/31/Semaphore_Error.svg', text: 'Kesalahan/Perhatian' },
  ],
  reference: [
    {
