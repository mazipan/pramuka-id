export default {
  ...
  prefix:
    'Bentuk lambang Gerakan Pramuka adalah gambar bayangan (siluet) tunas kelapa, sesuai dengan keputusan Kwartir Nasional nomor 06/KN/72, yang ditetapkan pada tanggal 31 Januari 1972. Arti kiasan lambang pramuka adalah sebagai berikut :',
  meanings: [
    ...
    'Buah nyiur tumbuh menjulang tinggi ke atas dan merupakan salah satu pohon yang tertinggi di Indonesia. Jadi lambang itu mengkiaskan bahwa seorang Pramuka mempunyai cita-cita yang tinggi dan lurus, mulia, jujur dan tegak tidak mudah diombang-ambingkan oleh sesuatu.',
  ...
  postfix:
    'Dari enam kiasan itulah diharapkan kepada setiap anggota Pramuka harus bergun a bagi diri, orang tua, sekolah, masyarakat dan Negara, bukan sebaliknya malah menjadi beban atau tanggungan orang lain.',
  overall_meaning:
    'Lambang Gerakan Pramuka merupakan tanda kebesaran jiwa setiap Pramuka. Lambang ini mengandung makna bahwa setiap Pramuka itu tangkas, sigap, sehat jasmani dan rohani, kuat dan ulet, berpengharpan penuh, besar tekad dan percaya diri dalam menghadpi segala tantangan hidup, berbudi luhur, bercita-cita tinggi, jujur dan tanggung jawab, hidup sederhana, berwatak kesatria, mampu menyesuaikan diri dimanapun berada dan dalam keadaan bagaimanapun juga, kuat dan teguh batinnya sehingga dapat menjadi pewaris dan penerus Bangsa yang lebih sanggup, lebih mampu dan bertanggung jawab dalam menabdikan dirinya pada bangsa dan Negara Kesatuan Republik Indonesia.',
  usage:
